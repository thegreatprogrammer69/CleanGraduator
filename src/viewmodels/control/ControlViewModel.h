...
namespace mvvm {
    ...
    struct ControlViewModelDeps {
        ...
        CalibrationSessionControlViewModel& calibration_session_vm;
    };
    ...
    public:
        ...
        CalibrationSessionControlViewModel& calibrationSessionViewModel();

    private:
        MotorControlViewModel& motor_vm_;
        DualValveControlViewModel& valves_vm_;
        CalibrationSessionControlViewModel& calibration_session_vm_;
    };
