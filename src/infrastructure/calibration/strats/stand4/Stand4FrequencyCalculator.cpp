...
infra::calib::stand4::Stand4FrequencyCalculator::~Stand4FrequencyCalculator() {
}

int infra::calib::stand4::Stand4FrequencyCalculator::frequency(double p_cur, double p_target, double dp_cur, double dp_target) {
...
void infra::calib::stand4::Stand4FrequencyCalculator::reset() {
    divider_ = divider_min_;
}
