#include "FileGaugePrecisionCatalog.h"
...
std::vector<GaugePrecision> FileGaugePrecisionCatalog::list() const
{
    return precisions_;
}

std::optional<GaugePrecision> FileGaugePrecisionCatalog::at(int idx) const
{
