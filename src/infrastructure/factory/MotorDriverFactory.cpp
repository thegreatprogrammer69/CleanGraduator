...
std::unique_ptr<domain::ports::IMotorDriver> MotorDriverFactory::load() {
    ...
    if (implementation == "g540lpt") {
        ...
        config.byte_close_both_flaps = section.getInt("byte_close_both_flaps", config.byte_close_both_flaps);
        config.byte_open_input_flap = section.getInt("byte_open_input_flap", config.byte_open_input_flap);
        config.byte_open_output_flap = section.getInt("byte_open_output_flap", config.byte_open_output_flap);
