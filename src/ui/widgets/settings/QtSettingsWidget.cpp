...
void QtSettingsWidget::buildUi() {
    ...
    auto* circleOverlayGroup = new QGroupBox(tr("Круг в центре кадра"), this);
    ...
    circleOverlayWidget_ = new QtCircleOverlaySettingsWidget(model_.circleOverlayViewModel(), circleOverlayGroup);
