    ...
    , model_(model)
{
    ...
    calibrationResultCard->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);

    auto* calibrationResultCardLayout = new QVBoxLayout(calibrationResultCard);
    calibrationResultCardLayout->setContentsMargins(12, 12, 12, 12);
    calibrationResultCardLayout->setSpacing(10);

    auto* calibrationResultSaveWidget = new QtCalibrationResultSaveWidget(model_.calibrationResultSaveViewModel(), calibrationResultCard);
    ...
    calibrationResultCardLayout->addWidget(calibrationResultSaveWidget, 0);
    calibrationResultCardLayout->addWidget(calibrationResultTable, 1);
